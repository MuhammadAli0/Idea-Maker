$(document).ready(function () {
    ...
    $(document).on('submit', '#update_account_form', function () {
        ...
        // submit form data to api
        $.ajax({
            url: "http://localhost:8080/Idea-Maker/api/index.php/updateUser",
            type: "POST",
                ...
                try {
                    ...
                    <form id='update_account_form'>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="firstname" id="firstname" required value="` + result['personal']['name']['fname'] + `" />
                        </div>

                        <div class="form-group">
                            <label for="lastname">Lastname</label>
                            <input type="text" class="form-control" name="lastname" id="lastname" required value="` + result['personal']['name']['lname'] + `" />
                        </div>

                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" name="email" id="email" required value="` + result['personal']['contact']['email'] + `" />
                        </div>
